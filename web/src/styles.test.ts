...
describe('responsive layout CSS', () => {
  ...
  it('styles native Yunbisai tabs, login, event list, and detail responsively', () => {
    expect(styles).toContain('.cloud-events-tabs {')
    expect(styles).toContain('.cloud-events-tab {')
    expect(styles).toContain('.cloud-events-tab[aria-selected="true"]')
    expect(styles).toContain('.yunbisai-login {')
    expect(styles).toContain('.yunbisai-qr-card {')
    expect(styles).toContain('min-width: 180px;')
    expect(styles).toContain('.yunbisai-account-list {')
    expect(styles).toContain('.yunbisai-my-event-list {')
    expect(styles).toContain('.yunbisai-my-event-card {')
    expect(styles).toContain('.yunbisai-my-event-detail {')
    expect(styles).toContain('.yunbisai-session-actions {')
    expect(styles).toContain('.yunbisai-detail-grid {')
