...
describe('responsive layout CSS', () => {
  ...
  it('keeps analysis information dense, scannable, and scroll-contained', () => {
    ...
    expect(styles).toContain('.chart-plot-bg {\n  fill: transparent;')
    expect(styles).toContain('.winrate-area {\n  fill: url(#winrateAreaGradient);')
    expect(styles).toContain('.score-line {\n  stroke: var(--signal);\n  stroke-width: 1.1;')
    expect(styles).toContain('stroke-dasharray: 4 5;')
    expect(styles).toContain('.chart-current-point {')
  ...
  it('opens the local game library below the light titlebar with compact icon actions', () => {
    ...
    expect(styles).toContain('.game-sidebar.expanded ~ .action-rail {')
    expect(styles).toContain('visibility: hidden;')
    expect(styles).toContain('.game-list-shell {\n  width: min(1040px, 100%);')
    expect(styles).toContain('.game-list-body.yuanluobo-record-list {')
    expect(styles).toContain('.game-list .game-row.yuanluobo-record-row {\n  grid-template-columns: minmax(0, 1fr) auto;')
  ...
  it('gives the yuanluobo browser a polished compact library treatment', () => {
    ...
    expect(styles).toContain('.yuanluobo-panel .yuanluobo-record-row {\n  position: relative;\n  width: 100%;\n  min-height: 88px;\n  display: grid;\n  grid-template-columns: minmax(0, 1fr) 42px 22px;')
    ...
    expect(styles).toContain('.yuanluobo-row-chevron {\n  grid-column: 3;\n  grid-row: 1 / span 2;\n  position: static;')
    ...
    expect(styles).toContain('.yuanluobo-browser {\n    gap: 6px;\n    overflow: hidden;')
    expect(styles).toContain('.yuanluobo-header {\n    min-height: 34px;\n    grid-template-columns: auto minmax(0, 1fr) auto;')
    expect(styles).toContain('.yuanluobo-title-block h2,\n  .yuanluobo-login-copy h2 {\n    font-size: 16px;')
    expect(styles).toContain('.yuanluobo-title-block span {\n    min-height: 18px;')
    expect(styles).toContain('.yuanluobo-panel .yuanluobo-back-button,\n  .yuanluobo-panel .yuanluobo-logout-button {\n    min-height: 34px;')
    expect(styles).toContain('.yuanluobo-filter-bar {\n    grid-template-columns: minmax(0, 1fr);\n    gap: 6px;')
    expect(styles).toContain('.yuanluobo-panel .yuanluobo-filter-trigger {\n    min-height: 44px;\n    grid-template-columns: 26px auto 1px minmax(0, 1fr) auto;')
    expect(styles).toContain('.yuanluobo-filter-icon {\n    width: 26px;\n    height: 26px;')
    expect(styles).toContain('.yuanluobo-filter-trigger strong {\n    font-size: 14px;')
    expect(styles).toContain('.yuanluobo-panel .yuanluobo-record-row {\n    min-height: 64px;\n    grid-template-columns: minmax(0, 1fr) 30px 16px;')
