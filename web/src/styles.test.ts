...
describe('responsive layout CSS', () => {
  ...
  it('uses a foldable portrait workspace with side-by-side analysis below the board', () => {
    ...
    expect(styles).toContain('.app-layout.side-action-layout {\n    --side-action-edge-gap: 12px;\n\n    grid-template-columns: minmax(0, 1fr) calc(var(--side-action-width, 42px) + var(--side-action-edge-gap));\n    grid-template-rows: auto minmax(0, 1fr) minmax(132px, 168px);')
