...
describe('responsive layout CSS', () => {
  ...
  it('keeps the portrait workspace ordered as toolbar, game info, board, controls, then analysis', () => {
    ...
    expect(styles).toContain('--portrait-overview-height: calc(var(--portrait-summary-height) + var(--portrait-overview-gap) + var(--portrait-chart-height) + var(--portrait-overview-padding-block) * 2);')
